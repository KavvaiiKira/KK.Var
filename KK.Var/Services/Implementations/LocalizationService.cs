...
public sealed class LocalizationService : ILocalizationService
{
    private static readonly IReadOnlyDictionary<string, string> English =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["Необязательная проверка выполняется после запуска systemd-сервиса."] = "An optional check runs after the systemd service starts.",
            ["Тип health-check"] = "Health-check type",
            ["Без проверки"] = "No check",
            ["Задержка стабильности"] = "Stability delay",
            ["HTTP-запрос"] = "HTTP request",
            ["TCP-порт"] = "TCP port",
            ["Команда"] = "Command",
            ["Время стабильной работы, секунд"] = "Stable operation time, seconds",
            ["Timeout, секунд"] = "Timeout, seconds",
            ["Интервал, секунд"] = "Interval, seconds",
            ["Количество попыток"] = "Number of attempts",
            ["HTTP-адрес"] = "HTTP address",
            ["Команда на удалённой машине"] = "Command on the remote machine",
            ["Выбран неподдерживаемый тип health-check."] = "The selected health-check type is not supported.",
            ["Задержка стабильности должна быть от 1 до 3600 секунд."] = "The stability delay must be between 1 and 3600 seconds.",
            ["Timeout health-check должен быть от 1 до 3600 секунд."] = "The health-check timeout must be between 1 and 3600 seconds.",
            ["Интервал health-check должен быть от 1 до 3600 секунд."] = "The health-check interval must be between 1 and 3600 seconds.",
            ["Количество попыток health-check должно быть от 1 до 100."] = "The number of health-check attempts must be between 1 and 100.",
            ["Укажите абсолютный HTTP- или HTTPS-адрес health-check."] = "Enter an absolute HTTP or HTTPS health-check address.",
            ["TCP-порт должен быть от 1 до 65535."] = "The TCP port must be between 1 and 65535.",
            ["Укажите команду health-check."] = "Enter the health-check command.",
            ...
            ["В очереди · позиция {0}"] = "Queued · position {0}",
